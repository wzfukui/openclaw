    ...
    if (
      ...
      parts.push(
        [
          ...
          "- Use the visible participant name after @. The ANI plugin will attach structured mention_public_ids and assigned_public_ids automatically when the target is unambiguous.",
          "- If someone is only context or audience, mention their name without @. A visible @ is treated as an execution assignment unless a tool explicitly sets assigned_public_ids.",
